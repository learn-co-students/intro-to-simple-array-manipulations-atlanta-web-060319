...
def using_pop(greatest_hits_of_the_nineties)
  @greatest_hits_of_the_nineties = ["Baby One More Time", "Smells Like Teen Spirit", "Ice Ice Baby", "Wonderwall", "Baby Got Back"]
  greatest_hits_of_the_nineties.pop 
end 

def pop_with_args(chars_in_game_of_thrones)
  @chars_in_game_of_thrones = ["Danny T.", "Tyrion Lannister", "Stable Boy", "Sandor Clegane"]
  @chars_arya_killed = chars_in_game_of_thrones.pop(2)
return chars_in_game_of_thrones.slice(2)
